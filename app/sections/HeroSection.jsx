    ...
    <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
      <div className="space-y-6">
        ...
        <Reveal delay={2} className="flex flex-wrap gap-4">
          <a href="/downloads/monilog-v1_1-release.apk" download onClick={onGatedDownload} className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-primary to-secondary px-6 py-3 text-sm font-semibold text-slate-950 shadow-xl shadow-primary/20 transition hover:opacity-95">
            Download Beta
          </a>
